...
class BertModel(object):
  ...
  def __init__(self,
    ...
    with tf.variable_scope(scope, default_name="bert", reuse=tf.AUTO_REUSE):
      with tf.variable_scope("embeddings"): #, tf.device('/device:gpu:1')
      ...
      with tf.variable_scope("encoder"): # , tf.device('/device:gpu:1')
      ...
      with tf.variable_scope("pooler"):  # , tf.device('/device:gpu:1')
